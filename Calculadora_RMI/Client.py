...
while n > 0:
    ...
    if operacao == 1:
        print(Client.adicao(nome, numero_1, numero_2))
    elif operacao == 2:
        print(Client.subtracao(nome, numero_1, numero_2))
    elif operacao == 3:
        print(Client.multiplicacao(nome, numero_1, numero_2))
    elif operacao == 4:
        print(Client.divisao(nome, numero_1, numero_2))
    elif operacao == 5:
        print(Client.raiz_quadrada(nome, numero_1, numero_2))
    else:
